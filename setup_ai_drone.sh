...
export ROS_PROJ_PATH="$HOME/catkin_ws"


export PX4_PATH="$ROS_PROJ_PATH/src/Firmware"

source "$ROS_PROJ_PATH/devel/setup.bash"


export GAZEBO_MODEL_PATH="$GAZEBO_MODEL_PATH:$ROS_PROJ_PATH/src/ai_drone_gazebo/models"
export GAZEBO_WORLD_PATH="$GAZEBO_WORLD_PATH:$ROS_PROJ_PATH/src/ai_drone_gazebo/worlds"
